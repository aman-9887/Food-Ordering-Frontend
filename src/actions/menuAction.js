...
//import { GET_MENU_REQUEST , GET_MENU_FAIL } from "../constants/menuConstant";


export const getMenus = (id) => async (dispatch) => {
    try {
      dispatch({ type: "GET_MENU_REQUEST" });
      const response = await axios.get(`https://food-ordering-backend-b1wc.onrender.com/api/v1/eats/stores/${id}/menus`);
